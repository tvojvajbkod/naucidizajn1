...
Marketing sajt se objavljuje na **GitHub Pages** (besplatno, automatski na svaki
push) ili na **Vercel** (kad zatrebaju forme i blog koji se sam osvežava).
Koraci za oba su u **[DEPLOY.md](DEPLOY.md)**.

```bash
bun run build:static   # statički izvoz u apps/marketing/out
```
