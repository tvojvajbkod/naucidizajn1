...
function useSidebar() {
  ...
  if (!context) {
    throw new Error("useSidebar mora da se koristi unutar SidebarProvider-a.");
  }
  return context;
}
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Prazan div koji drži prostor sidebara u layout-u */}
      <div
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">Otvori/zatvori sidebar</span>
    </Button>
  );
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label="Otvori/zatvori sidebar"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="Otvori/zatvori sidebar"
      className={cn(
