    ...
    <main>
      <section className="border-b bg-muted/40">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          ...
          {/* Cena, paketi i rate se razlikuju od kursa do kursa — zato dolaze
              iz `courses.ts`, a ne kao jedna rečenica za sve. */}
          <p className="mt-4 text-muted-foreground text-sm">
            {course.priceNote} {course.installments}
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-6 py-16 md:grid-cols-[1.4fr_1fr] md:py-20">
        ...
        <aside className="h-fit rounded-2xl border bg-card p-7">
          ...
          <p className="mt-6 border-border/70 border-t pt-6 text-muted-foreground text-sm leading-relaxed">
            {course.priceNote} {course.installments} Uz svaki kupljen paket ide bonus: mesec dana
            grupnog mentorstva i video predavanje „Portfolio koji te vodi do posla". Na svim
            paketima važi garancija povraćaja novca u roku od 14 dana.
          </p>
